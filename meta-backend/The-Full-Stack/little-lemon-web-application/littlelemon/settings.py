...
DATABASES = {
    'default': {
        ...
        'NAME': config('MYSQL_DATABASE', default='littlelemon_db'),
        'USER': config('MYSQL_USER', default='littlelemon_user'),
        'PASSWORD': config('MYSQL_PASSWORD', default='littlelemon_password'),
